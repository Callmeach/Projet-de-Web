...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 20 jan. 2022 à 15:26
...
CREATE TABLE `admin` (
  ...
  `password` char(8) NOT NULL DEFAULT 'admin'
...
--
ALTER TABLE `articles`
  MODIFY `idArticle` tinyint(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT pour la table `etudiants`
--
ALTER TABLE `etudiants`
  MODIFY `idEtudiant` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
